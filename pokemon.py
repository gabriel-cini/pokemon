...
pokemon1 = Combat("Charizard", 100)
pokemon2 = Combat("Tortank", 100)
...
# exemple de Pokemon
pikachu = Electrique("Pikachu", 30, 40, 100)
salamèche = Feu("Salameche", 20, 50, 80)
carapuce = Eau("Carapuce", 35, 35, 120)
bulbizarre = Plante("Bulbizarre", 25, 45, 90)

# Ajout des Pokémon au Pokédex
pokedex.ajouter_pokemon(pikachu)
pokedex.ajouter_pokemon(salamèche)
